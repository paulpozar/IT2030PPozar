    ...
    public class MoviesController : Controller
    {
        ...
        public List<Movie> ListOfMovies()
        {
            List<Movie> movies = new List<Movie>()
            {
                ...
                new Movie {MovieId = 3, Title = "Captain America"}
            };
            return movies;
        }
        ...
        public ActionResult Create([Bind(Include = "MovieId,Title,Year")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MovieId,Title,Year")] Movie movie)
        {
            if (ModelState.IsValid)
            {
